...
#include "open_spiel/algorithms/alpha_zero_torch/lts_self_play.h"
#include "open_spiel/utils/file.h"
#include "open_spiel/utils/json.h"
#include "open_spiel/utils/thread.h"

ABSL_FLAG(std::string, game, "tic_tac_toe", "The name of the game to play.");
ABSL_FLAG(std::string, path, "/Users/zaheen/Documents/2lts/ttt/logs_1", "Where to output the logs.");
...
int main(int argc, char** argv) {
  ...
  bool resuming;
  open_spiel::algorithms::torch_az::LTSConfig config;
  ...
  return !LTSSelfPlay(config, &stop_token, resuming);
}
